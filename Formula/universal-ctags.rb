class UniversalCtags < Formula
  desc "Maintained ctags implementation (incl clojure.core/defn patch)"
  homepage "https://github.com/razum2um/ctags"
  head "https://github.com/razum2um/ctags.git"
  ...
  test do
    ...
    EOS
    system "#{bin}/ctags", "-R", "."
    assert_match /core-function-with-body.*test\.clj/, File.read("tags")
  end
end
